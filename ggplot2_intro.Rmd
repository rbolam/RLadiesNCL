...
There is also a handy website which shows all the colour options with ColorBrewer, and you can filter them as well, for example for colour-blind friendly palettes: http://colorbrewer2.org/
...
ggplot(data = diamonds, aes(x = carat)) + geom_area(stat = "bin", aes(fill = color), position = "fill") + scale_fill_brewer(palette = "Greens")
```
